...
export default ({ mobileBrowser, handleHover, handleMobileResumeClick, hoverDepth, hoverBreadth, handleMouseCallback, style, style: { resumeContainer, resumeContainerTitle }, resume: { resume_Details, resume_Name } }) => {
  return (
